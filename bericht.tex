...
\begin{abstract}
  ...
  Erfassung von Automationen, Regeln und Geräten können die Aufwände der Anwender, bzw. Entwickler rasant ansteigend. 
  ...
  klare Struktur zur Definition von Regeln, sodass Anwendungsfälle in wenigen Schritten umgesetzt werden können. Die Komplexität dieser ist jedoch 
  abhängig von dem zu realisierenden Prozess uns kann durch die Struktur selbst nicht reduziert werden. 
  \\
  ...
  angewendet. Es wird ein systematischen Literaturreview durchgeführt, welches das Ziel verfolgt, Möglichkeiten zur Entwicklung eines Ansatzes identifizieren, der die Usability 
  ...
  Anschließend wird eine Zielgruppenanalyse durchgeführt, sowie Anwendungsfälle entwickelt und Experteninterviews geführt, wodurch Anforderungen an das System identifiziert werden. 
  ...
  auf die Usability überprüft werden kann und die Anforderungen als auch die Forschungsfrage evaluiert werden können, werden nach der Implementierung 
