%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Descr:       Vorlage für die Masterthesis an der KFRU 
...
\begin{abstract}
  ...
  der Regeldefinitionen vorzunehmen. 
  \\
  \linebreak
  Diese Masterthesis befasst sich mit der Konzeption und prototypischen Umsetzung eines Frameworks einer Steuerzentrale im Rahmen eines 
  intelligenten Büros mit dem Fokus auf eine einfache Handhabung der formalisierten Interaktionen für Softwareentwickler. Das System bietet eine 
