...
\begin{abstract}
  ...
  Usability-Tests und abschließende Experteninterviews durchgeführt. Diese helfen bei der Evaluation. 
\end{abstract}
...
\begin{abstract}
  ...
  \\
  \linebreak
  This master's thesis deals with the conception and prototypical implementation of a framework for a control center within the framework of a 
  intelligent offices with a focus on easy handling of formalized interactions for software developers. The system offers a clear structure 
  ...
  analysis is then carried out, use cases are developed and expert interviews are conducted, whereby requirements for the system are extracted and 
  ...
  concluding expert interviews are carried out after implementation. These help with the evaluation. 
\end{abstract}
