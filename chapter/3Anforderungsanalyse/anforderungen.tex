...
\label{sec:zielgruppenanalyse}
    ...
    Im Rahmen dieser Tätigkeit wird die konkrete Zielgruppe identifiziert, die das Framework als Grundlage nutzen, um die individuellen 
    Anwendungsfälle in der Umgebung des Büros umzusetzen und ggf. erweitern. Die Verwendung des Frameworks ist nicht zwangläsufig auf die Büroumgebung zu reduzieren, ebenso kann 
    ...
    \label{subsec:zielgruppendefinition}
        Zur Bestimmung einer Zielgruppe unter Verwendung des Prozesstemplates der \textit{Target Group Analysis} wird anhand von 
        Kriterien die konkrete Zielgruppe definiert. Hierfür werden folgende Merkmale verwendet: 
        \begin{itemize}
            \item Beruf: \textit{Ist das System nur für bestimmte Berufsgruppen interessant?} - 
            \item Bildung: \textit{Über welchen Bildungsstand verfügt die Zielgruppe, die das System anspricht?} - 
            \item Interessen: \textit{Für Personen welcher Interessengebiete ist das System relevant?} - 
            \item Werte: \textit{Über welche Werte verfügen die Interessenten?} - 
        \end{itemize} 
        ...
        Statistiken und Umfragen genutzt. %wird die Erläuterung der Zielgruppe gestützt. 
        
        %Damit im Rahmen der Zielgruppenanalyse eine bestimmte Zielgruppe identifiziert werden kann     
