    ...
    \begin{table}[hbt!]
        \begin{center}
            \begin{tabular}{ | p{1.0cm} | p{9.2cm} | p{1.6cm} | p{3.1cm} | }
                ...
                %\hline
                %   ZAF6 & Die Zustände der Komponenten sollten persistiert werden, damit bei einem Systemausfall die letzten Transaktionen und Änderungen nachvollzogen werden können. & Mittel & Experteninterview \\ 
                %\hline 
            \end{tabular}
        \end{center}
