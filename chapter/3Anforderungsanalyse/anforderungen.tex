...
\label{sec:usecases}
    Für die Erhebung und Ausarbeitung von Anforderungen an das System und an die einfache Handhabung der formalisierten 
    Interaktionen des Softwareentwicklers zur Erweiterung des Systems und deren Regeln werden Anwendungsfälle, sogenannte 
    Use Cases, definiert, bewertet und auf ihre Funktionalität geprüft und dokumentiert. Diese werden im Rahmen des \acl{RE} 
    dokumentiert. Das \acs{RE} nach \cite{pohl2021basiswissen} gibt Schablonen, Vorgehensmodelle und Aufgaben vor, die dabei 
    helfen aus den Sachverhalten und Anwendungsfällen die Anforderungen ableiten zu können. Nach dem Vorgehensmodell 
    Scrum 

    
    Zum besseren Verständnis wird auf 
    diese in den folgenden Abschnitten eingegangen. 
