...
\label{sec:requirementsFinal}
    ...
    der durchgeführten Experteninterviews ergaben sich Anforderungen an das System, %als auch Bausteine, 
    die in der Konzeption und der anschließenden prototypischen Implementierung zu berücksichtigen sind. %der Software essentiell sind. 
    %Da der Fokus dieser 
