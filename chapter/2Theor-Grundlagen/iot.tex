...
\label{sec:smartHome}
    ...
    \label{subsec:smartoffice}
        ...
        Büroräume, unter anderem durch Reduzierung des Stromverbrauchs. Eine große Rolle spielen in einem intelligente 
        Büro ebenso als im intelligenten Zuhause die Automation 
