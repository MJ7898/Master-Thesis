...
\label{sec:openhab} 
    ...
    Ähnlich zu der vorgestellten Home Assistant Software, bietet \acs{OPENHAB} ebenso User Interfaces die durch 
...
\label{sec:historyoHAB}
    ...
    Im Februar 2010 wurde das Projekt unter dem Name \acs{OPENHAB} bekannt. Nach zweieinhalb jähriger Entwicklung, im Dezember 2012, 
...
\subsection{Konzept und Architektur}
    ...
    \begin{itemize}
        ...
        Mit \acs{OPENHAB} 3 würden weitere Möglichkeiten hinzugefügt, um benutzerdefinierte \acs{UI}, Diagramme, Grundrisse und oder 
    ...
    %\pagebreak
    \linebreak
    Mit der wesentlichen Aktualisierung von \acs{OPENHAB} zur aktuellen Version \acs{OPENHAB} 2.0 gab es auch einige Änderungen an der 
...
\subsection{Stärken und Schwächen}
    ...
    \subsection{Optionen der Regel- und Automatisierungserstellung}
        ...
        \acs{OPENHAB} verwendet für die Syntax der Regeldefinition Xbase\footnote{Erklärung des Xtext, bzw. Xbase Frameworks. \url{https://www.eclipse.org/Xtext/index.html} Abgerufen am 29.05.2022} 
