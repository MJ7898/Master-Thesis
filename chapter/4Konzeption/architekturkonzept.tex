...
\label{sec:architekturkonzept}
    ...
    \subsection{Aufbau des Frameworks}
        ...
        \\
        \linebreak
        Die durch den Anwender implementierte Transformation, die basierend auf einem eingehenden \acs{MQTT}-Topic das Zustandsobjekt verändert, soll das 
        \textit{Adapter} Pattern verwenden. Dadurch können Events aus unterschiedlichen Services und mehreren Kommunikationswegen entgegengenommen werden, ohne das 
        die eigentliche Schnittstelle modifiziert wird. %Erläuterung des Adapter Pattern...  
        Zusätzlich stützt das \textit{Template Method} Pattern die Struktur der Transformation, die je nach Komponente und Regel unterschiedliche Eingangswerte definiert. 
        Innerhalb dieser Schablone sollen alle Attribute vorgegeben, die für die Transformation notwendig sind. %TBD.. durchlesen / verbessern.
        \\
