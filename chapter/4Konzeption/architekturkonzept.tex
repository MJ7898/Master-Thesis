...
\label{sec:architekturkonzept}
    ...
    Webanwendung handelt und keine direkte Kommunikation zwischen Clients und Server stattfindet, wird ein solches allgemeines 
    ...
    \subsection{Generische Programmierung in Java} % Typisierung
        ...
        Regeln, des Zustandsraumes und den dafür notwendigen Bedingungen beibehält, ist die Entscheidung 
        ...
        jeweilige Objekt übergeben. So ist zur Laufzeit das konkrete Objekt bekannt. Zur Veranschaulichung dient folgendes Code-Beispiel:
\begin{lstlisting}[language=Java, frame=lines, xleftmargin=\parindent, style=algoBericht, label={code:pubmqtt}, captionpos=b, caption={Zustandsobjekt als Typ-Variable}]
...
\end{lstlisting}
        ...
        \\
        Mit dieser Entscheidung kann das Framework generisch definiert und Zustandsraum vom Anwender der individuell implementiert werden.
        \\
        \linebreak
        Die Darstellung des Zustandsobjektes wird für die Vollständigkeit der folgenden Diagramme vorausgesetzt. Diese beschreiben jedoch zu keinem 
        Zeitpunkt eine konkrete Struktur.

    \subsection{Aufbau der Komponenten}
    %WICHTIG!!!: Verwendung der Typisierung, um dem Anwender die Möglichkeit der offenen Gestaltung des Zustandobjektes zu gewährleisten. 
