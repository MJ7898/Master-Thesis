...
\end{lstlisting}
    ...
    \subsection{Aufbau des Frameworks}
        Nach Veranschaulichung der Schichten-Modellierung wird übergreifend der Komponenten Aufbau, sowie die dafür eingesetzten Architekturmuster aufgegriffen. 
        \\
        ...
        und anwenden kann. Um zu gewährleisten, dass dem Anwender diese Methoden zur Implementierung zur Verfügung stehen, wird mittels dem 
