...
\subsection{Implementierung von Anwendungsfällen}
    ...
    Steckdosen-Funkmodul. Die beiden Methoden sind überschaubar und mit weniger als fünf Zeilen Code implementiert. Dem folgenden Quellcode-Ausschnitt sind die folgenden Methoden 
    zu entnehmen:
...
\end{lstlisting}
    ...
    aufwändig mit vielen Interaktionen. Ergänzend dazu ist dem Anhang ein Ausschnitt der Konfigurationsdatei beigefügt (siehe Anhang \ref{appendix:hoasAutomation}).
    \\
    \linebreak
    ...
    mittels der \textit{Rule \acs{DSL}} hingegen kann mit der der Steuerzentrale verglichen werden. Diese ist in ähnlich wenigen Schritten realisiert. Der folgende 
    Quellcode-Ausschnitt zeigt den Umfang der Regel über die \acs{OPENHAB} \acs{DSL}:
...
\end{lstlisting}
    ...
    \subsubsection*{Check-in mit einem Service-Roboter}
        ...
        \begin{figure}[hbt!]
            \centering
            \includegraphics[width=14cm,height=9cm,keepaspectratio]{images/sequence_rule_temi_greet.png}
        ...
        Usability-Tests \ref{sec:usabilitytest}, zur Überprüfung der Nutzbarkeit, wurde ein \textit{Mock}\footnote{Simulierte Objekte in der objekt-orientieren Programmierung. \url{https://en.wikipedia.org/wiki/Mock_object} Besucht am 02.08.2022} 
