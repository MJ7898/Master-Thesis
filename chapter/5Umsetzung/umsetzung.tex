...
\label{subsec:zustandsraum}
    Der vom Anwender zu definierende Zustandsraum stellt ein einfaches Java Objekt dar, das in einer eigenen Klasse definiert wird. 
    ...
    Werten \textit{true} und \textit{false} oder als \textit{String} mit den Zeichenketten \textit{"on"} und \textit{"off} definiert 
...
%WICHTIG: ZUSTANDSRAUM MODELLIERUNG VON KOMPONENTEN, BZW. OBJEKTE SIND NICHT MÖGLICH, 
%DA DIES AN DIE GRENZE VON JAVA REFLECITON KOMMT. IST ABER AUCH NICHT NÖTIG, DA ALLE 
