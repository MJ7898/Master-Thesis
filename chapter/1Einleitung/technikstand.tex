...
\section{Zusammenfassung} 
    ...
    \subsection{Stand der Technik aus Nutzer- und Produktsicht}
        ...
        und openHAB, die eine gewisse Technikaffinität erfordern und voraussetzen, um diese nach belieben einsetzen zu können. 
        Viele große Unternehmen, darunter Bosch, Telekom, Siemens, Samsung und viele mehr bieten Geräte und Softwarelösungen, 
        die der Nutzer als reine Anwendung benutzt. Diese geben keinen Einblick in ihre Software und deren Umsetzung, 
        daher sind diese nicht weiter zu berücksichtigen. 
        \\
        \linebreak
        Neben den bekanntesten Plattformen openHAB und Home Assistant gibt es weitere Lösungen, die eine Platform zur 
        Verfügung stellen:
        \begin{itemize}
            \item OpenMotics
            \item Jeedom
        ...
        Durch die Vielzahl der Angebote und den immer größer werdenden Mehrwert, den eine solche Platform bietet, 
        nimmt die Forschung und Entwicklung in dem Bereich des \acs{IoT} immer mehr zu. Dadurch können immer mehr 
