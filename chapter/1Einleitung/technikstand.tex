...
\section{Zusammenfassung} 
    ...
    \label{subsec:publications}
        ...
        \subsubsection*{Fast-prototyping Approach to Design and Validate Architectures for Smart Home}  
            ...
            %Mit diesem Grundsatz sind gute Lerneffekt zu erzielen, indem diese Technologie zu praktischen Arbeiten im Forschungs- und 
    ...
    Verhältnis zu der in dieser Arbeit gestellten Forschungsfrage. Diese zeigen Ausschnitte von Forschungen, die 
    mittels dem systematischen Literaturreviews gefunden wurden. %, da mit dem systematischen Literaturreview keine Literatur 
    %gefunden werden konnte, die sich ausschließlich dem zu behandelnden Thema widmet. 
    Die zusammengefassten Arbeiten dienen 
    ...
    wird dieser in folgendem aus einer etwas pragmatischeren Sichtweise erläutert. %der Stand der Technik skizziert.
    ...
    \subsection{Stand der Technik aus Nutzer- und Produktsicht}
        ...
        einzelne Intelligente Geräte, die nichts zwangsläufig eine zentrale Steuerungsplattform benötigen und Plattformen, wie bspw. 
        ...
        \begin{itemize}
            ...
            \item Homebridge.io
        \end{itemize}
        Die Auflistung gibt nicht alle am Markt verfügbaren Produkte wieder, lediglich eine kleine Auswahl, die jedoch nicht weiter ausgeführt wird. %.Neben den aufgelisteten Produkten gibt es viele mehr, die jedoch nicht weiter aufgeführt werden. 
        ...
        Anwendungsfälle abgedeckt und realisiert werden, wodurch dem Nutzer die Einsatzmöglichkeiten deutlicher aufgezeigt und 
        ...
        Diese sind dafür entwickelt, um bestimme Regeln, Prozesse und Sachverhalte definieren und durchlaufen zu können. 
        Einsatz finden diese Frameworks in \ac{BRMS}, in Systemen, die durch Regeln eine bestimmte Logik erfüllen und 
        wiederholt auftreten und ausgelöst werden können, sowie in 
        \acl{SH} Plattformen. Durch die Definition von Regel und Automatisierungen können wiederkehrende Prozesse in einem smarten 
