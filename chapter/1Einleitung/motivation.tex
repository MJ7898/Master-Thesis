...
\label{sec:aufbau}
    ...
    gefolgt von einer Einführung in die Thematik des \acl{SM}s (\ref{sec:smartHome}), der Problematik der Begriffsdefinition, der 
    ...
    werden sollen. Mit dem Verständnis der übergeordneten Begriffe, \acs{IoT} und \acs{SM}, werden Technologien 
    ...
    von der Umsetzung eines \acl{SM}s einzugehen und einen Teilaspekt der Anforderungen Abzudecken, wird ebenso auf Service-Roboter 
