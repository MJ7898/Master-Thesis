...
\label{sec:zielsetzung}
    ...
    %Erarbeitung eines Konzeptes für ein Framework, welches dem Softwareentwickler das Umsetzen von Regeln (und zu automatisierende Prozesse )
    %im Rahmen der Programmierung erleichtert und in der Ausprägung der Möglichkeiten nicht einschränkt. Dabei wird sich an 
    % den bestehenden Produkten orientiert, die versuchen, 
